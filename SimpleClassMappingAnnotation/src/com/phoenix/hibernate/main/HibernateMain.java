...
public class HibernateMain {
	...
	public static void main(String[] args) {
		...
		//Adding product
		//Product p = new Product(3012, "Bike", "Ducati Panigale V4", 2400000.00f);
		//ss.save(p);
		
//		Product p = ss.load(Product.class, 3012);
...
//		System.out.println("Price: "+p.getPrice());
		...
		//Product p = ss.get(Product.class, 3010);
//		if(p!=null) {
